 ...
 */
public class StaticFileServletWithRange extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5864114957144495765L;
	private static final int DEFAULT_BUFFER_SIZE = 10240; // ..bytes = 10KB.
    private static final long DEFAULT_EXPIRE_TIME = 604800000L; // ..ms = 1 week.
    private static final String MULTIPART_BOUNDARY = "MULTIPART_BYTERANGES";
    private static final Logger LOG = LoggerFactory.getLogger(StaticFileServletWithRange.class);
...
//        File file = new File(inputFilePath, URLDecoder.decode(inputFilePath, "UTF-8"));
...
//            disposition = accept != null && accepts(accept, type) ? "inline" : "attachment";
//        }
